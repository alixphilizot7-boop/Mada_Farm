...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-amber-50 via-stone-50 to-emerald-50 px-4 dark:from-stone-950 dark:via-stone-950 dark:to-emerald-950">
